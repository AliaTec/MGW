...
Public Class DAO
    ...
    Private Const LayoutDispersionHSBCMT As String = "sp_Reporte_LayoutDispersionHSBC_MT103 '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@Anio','@Periodo','@UID','@LID','@idAccion'"
    ...
    Public Function LayoutTxt(ByVal ReportesProceso As EntitiesITX.ReportesProceso, ByVal opL As String, ByVal context As System.Web.HttpContext) As String
        ...
        Try
            Select Case opL
                ...
                Case "LayoutDispersionHSBCMT"
                    ...
                    UserId = UserId.Replace("-", "")
                    sFile = "\LayoutDispersionHSBCMT" + ReportesProceso.IdRazonSocial.ToString + UserId + Date.Now.Second.ToString + ".txt"

                    results.getEntitiesFromDataReader(objLayoutDispersion, Me.ReporteDispersionHSBCMT(ReportesProceso))
                    dTotalImporte = 0
                    If results.Count > 0 Then
                        ...
                        For i = 0 To results.Count - 1
                            sCadena = results(i).centroCosto & vbCrLf
                            sCadena = sCadena + results(i).cuenta & vbCrLf
                            sCadena = sCadena + results(i).claveContable & vbCrLf
                            sCadena = sCadena + results(i).conceptoPago & vbCrLf
                            sCadena = sCadena + results(i).cuentaContable & vbCrLf
                            sCadena = sCadena + results(i).cuentaEmpresa & vbCrLf
                            sCadena = sCadena + results(i).descripcionContable & vbCrLf
                            sCadena = sCadena + results(i).division & vbCrLf
                            sCadena = sCadena + results(i).nombreEmpleado & vbCrLf
                            sCadena = sCadena + results(i).subArea & vbCrLf
                            sCadena = sCadena + results(i).tipoCuenta
                ...
                Case "LayoutPolizaContable"
                    ...
                    UserId = UserId.Replace("_", "")
                    UserId = UserId.Replace("-", "")
                    sFile = "\LayoutPolizaContable" + ReportesProceso.IdRazonSocial.ToString + UserId + Date.Now.Second.ToString + ".txt"

                    results.getEntitiesFromDataReader(objLayoutDispersion, Me.ReportePolizaContable(ReportesProceso))
                    dTotalImporte = 0
                    If results.Count > 0 Then
                        Dim sb As New FileStream(context.Server.MapPath(sPathApp + sPathArchivosTemp) + sFile, FileMode.Create)
                        Dim sw As New StreamWriter(sb)
        ...
        Return ""
    End Function
    Public Function ReporteDispersionHSBCMT(ByVal ReportesProceso As EntitiesITX.ReportesProceso) As SqlDataReader
        Dim data As SqlDataReader = Nothing
        Dim resultado As Boolean
        Dim comandstr As String
        Try
            comandstr = LayoutDispersionHSBCMT
    ...
    Public Function ReportePolizaContable(ByVal ReportesProceso As EntitiesITX.ReportesProceso) As SqlDataReader
        Dim data As SqlDataReader = Nothing
        Dim resultado As Boolean
        Dim comandstr As String
        Try
