...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'spq_nomGraExenMensuales @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<%IdTipoNominaAsig%>,@IdTipoNominaProc = <%IdTipoNominaProc%>,@Anio = <%Anio%>,@Periodo = <%Periodo%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)

        RPT.DataSource = New DataDynamics.ActiveReports.DataSources.OleDBDataSource("Provider=SQLOLEDB.1;" + sConnection, "spq_nomGraExenPeriodo @IdRazonSocial = <%IdRazonSocial%>,@IdTipoNominaAsig=<%IdTipoNominaAsig%>,@IdTipoNominaProc = <%IdTipoNominaProc%>,@Anio = <%Anio%>,@Periodo = <%Periodo%>,@UID = <%UID%>, @LID = <%LID%>, @idAccion = <%idAccion%>", 90)
